const cardsData = [
    ...
    htmlContent: `
      <article class="card01">
        ...
        <div class="card-overlay flex---">
          ...
          <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Earum, alias, voluptatem, laboriosam optio adipisci corporis.</p>
          <a href="javascript:void(0)" class="card-btn">View Details</a>
          <h3 class="card-subtitle" data-text="Prime Location">Prime Location</h3>
        </div>
      </article>
    `
  },
  {
    ...
    altText: "Preview of Card News",
    htmlContent: `
      <article class="card-news">
        <div class="card-news-image">
          <span class="badge-news">Technology</span>
        </div>
        <div class="card-news-body">
          ...
          <p class="card-news-excerpt">Modern tools are transforming how developers build complex interfaces, streamlining CSS and HTML workflows.</p>
        ...
        <div class="cyber-card-inner">
          <div class="card-content">
            ...
            <div class="product-display">
              ...
              <div class="tech-specs-overlay">24GB GDDR6X | DLSS 3.5</div>
            </div>
            <div>
            ...
            <div class="btn-cyber">ACQUIRE CORE</div>
          </div>
        </div>
      </div>
    `
